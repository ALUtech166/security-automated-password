...
async function createApp(ssrContext, config = {}) {
  ...
  if (typeof nuxt_plugin_plugin_0f2e1aec === 'function') {
    await nuxt_plugin_plugin_0f2e1aec(app.context, inject)
  }

  if (typeof nuxt_plugin_plugin_74f724b8 === 'function') {
    await nuxt_plugin_plugin_74f724b8(app.context, inject)
  }

  if (process.client && typeof nuxt_plugin_vuescrollto_b647152e === 'function') {
